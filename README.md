...
- Counter - Project from FCC's Relational Database course using bash to create a basic script that countsdown a timer given a user input for the starting value.
